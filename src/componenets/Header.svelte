  ...
  <div class="header__container container">
    ...
    <div class="header__nav-content">
      <a
        ...
        class="btn btn--secondary btn--icon phone-button"
        title="+48 58 506 65 65"
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
          height="16"
      ...
      <button
        class="btn btn--primary mobile-nav-button btn--icon"
        on:click={toggleMenu}
        title="Toggle menu"
      >
        <svg
